...
Эксперимент проводится на случайном изображении <img width="858" height="1832" alt="test1" src="https://github.com/user-attachments/assets/d4d3a323-2d34-469a-b66f-a7ac55d75122" />
, и результаты времени выполнения сравниваются между CPU и GPU.
